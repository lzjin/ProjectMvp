...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        //MLog.e("======发送======请求方式="+request.method()+"");
        MLog.e( "======发送======请求链接="+request.url()+"");
        MLog.e( "======发送======请求头="+request.headers()+"");
        MLog.e( "======发送======请求body="+body+"");
        ...
        MLog.e( "======接收======响应码="+response.code()+"");
        //MLog.e( "======接收======信息="+response.message()+"");
       // MLog.e("======接收======tookMs="+tookMs+"");
        //MLog.e("======接收======body="+body+"");
        MLog.e("======接收======json="+rBody+"");
